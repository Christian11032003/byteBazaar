...
public class UtenteController
{
    ...
    public ResponseEntity<Void> bloccaUtente(@RequestBody BannedOrUnBannedAdminRequest request) throws MessaggioUtenteUnauthorizedException, MessaggioUtenteNotFoundException  {
    ...
    public ResponseEntity<List<Utente>> findAllClienti(LoginRequest request) throws MessaggioUtenteUnauthorizedException{
    ...
    public ResponseEntity<List<Utente>> findAllVenditori(LoginRequest request) throws MessaggioUtenteUnauthorizedException{
    ...
    public ResponseEntity<List<Utente>> findAllClientiVenditori(LoginRequest request) throws MessaggioUtenteUnauthorizedException{
    ...
    @PostMapping("/login")
    public ResponseEntity<LoginResponse> login(@RequestBody LoginRequest request) throws MessaggioUtenteNotFoundException {
